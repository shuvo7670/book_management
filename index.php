  ...
  <div class="formbold-form-wrapper">
    <form action="add-book.php" method="POST">
      <div class="formbold-form-title">
        ...
        <div>
            <label for="book_name" class="formbold-form-label">
            Book Name
            </label>
            <input
                type="text"
        ...
        <div>
          <label for="publisher" class="formbold-form-label"> Publisher </label>
          <input
            type="text"
            name="publisher"
            id="publisher"
        ...
        <div>
          ...
          <textarea name="description" id="description" class="formbold-form-input"></textarea>
        </div>
