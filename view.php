...
<head>
    ...
    <?php 
        $id     = $_GET['id'];
        $sql    = "SELECT books.*, categories.name AS category_name FROM `books` JOIN categories ON books.category = categories.id WHERE books.id = $id";
...
<body class="bg-light">
  <div class="container py-5">
    <div class="card p-4 shadow-sm">
      <div class="row">
        <div class="col-md-4">
          <img style="max-width: 100%;" src="<?php echo $book['cover_image_url'] ?>" alt="">
        </div>
        <div class="col-md-8">
